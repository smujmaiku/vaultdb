...
describe('VaultDb', function() {
	...
	describe('broadcast', () => {
		it('should set data to quickly expire', async () => {
			...
			expect(db.set).toBeCalledWith('b', 2, 1);
		});
		...
		it('should not debounce the emitter', async () => {
			...
			expect(db.set).toBeCalledWith('c', 3, 1);
		...
		it('should accept an Object', async () => {
			...
			expect(db.set).toBeCalledWith('a', 1, 1);
			expect(db.set).toBeCalledWith('b.c', 2, 1);
			expect(db.set).toBeCalledTimes(2);
		});
	});
